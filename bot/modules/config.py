...
@app.on_message(
    filters.command(["setvar", f"setvar@{bot.username}"]) & filters.user(OWNER_ID)
)
@check_heroku
...
@app.on_message(
    filters.command(["delvar", f"delvar@{bot.username}"]) & filters.user(OWNER_ID)
)
@check_heroku
...
@app.on_message(
    filters.command(
        [
            BotCommands.ConfigMenuCommand,
            f"{BotCommands.ConfigMenuCommand}@{bot.username}",
        ]
    )
